...
const totalAveragePlaytimePerGame = players.reduce((playtimePerGame, player.playtime / player.gamesPlayed) => {return playtimePerGame + player.playtime/player.gamesPlayed;},0);
